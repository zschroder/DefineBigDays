...
BigDays.sfdfT %>%
  ...
  summarize(count = n())
```
**Table: Total number of big days associated with each Z time.**
...
write.csv(x, "BigDaysinLargeGroups.csv")
```
...
```{r}
#1995 Data: 
  rb <- raster("/Volumes/Zoe's Work/PhD_Program/Projects/PopDens/usadens/usads95g/w001001.adf")
...
#2000 Data: 
  rb <- raster(paste0("/Volumes/Zoe's Work/PhD_Program/Projects/PopDens", "/gpw-v4-population-density-rev11_2000_2pt5_min_tif/gpw_v4_population_density_rev11_2000_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2005 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Work/PhD_Program/Projects/PopDens", "/gpw-v4-population-density-rev11_2005_2pt5_min_tif/gpw_v4_population_density_rev11_2005_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2010 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Work/PhD_Program/Projects/PopDens", "/gpw-v4-population-density-rev11_2010_2pt5_min_tif/gpw_v4_population_density_rev11_2010_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
#2015 Data: 
    rb <- raster(paste0("/Volumes/Zoe's Work/PhD_Program/Projects/PopDens", "/gpw-v4-population-density-rev11_2015_2pt5_min_tif/gpw_v4_population_density_rev11_2015_2pt5_min.tif"))
  ext = raster::extent(c(-125, -67, 24, 50))
  PopDens = crop(rb, ext)
...
```{r}
#save(BigDays.sfdfT, BigDayTornadoes, Groups.sfdfT, GroupTornadoes, All_Tornadoes, file = "BigDaysinLargeGroups.RData")
